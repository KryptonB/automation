#########################################################################
#
# This script will log into Artologik and keep watching until a new mail 
# arrives and inform us / narrate us when a new mail comes in.
